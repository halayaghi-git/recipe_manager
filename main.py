...
@app.get("/")
def root():
    return {"message": "Welcome to Recipe Manager API! Visit /docs for API documentation"}
...
def filter_recipes_endpoint(meal_type: str = None, cuisine: str = None, db: Session = Depends(get_db)):
